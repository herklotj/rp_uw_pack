view: expoclm {
    ...
    FROM
      ...
      SELECT
         ...
         left join
          ...
          LEFT JOIN
              rated_areas_withmargins m ON UPPER(replace(e.postcode, ' ','') ) = upper( replace(m.postcode, ' ','') )
  ...
  dimension: postcode_sector_margin {
    type: number
    sql:  ${TABLE}.ra_ad_margin ;;
  }
